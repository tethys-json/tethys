...
trait WriteBuilderUtils extends MacroUtils {
  ...
  case class MacroWriteDescription(
      tpe: Type,
      config: c.Expr[WriterDerivationConfig],
      operations: Seq[BuilderMacroOperation]
  )
  ...
  implicit lazy val macroWriteDescriptionUnliftable
    ...
    Unliftable[MacroWriteDescription] {
      case q"$pack.WriterDescription.apply[${tpe: Tree}](${config: Tree}, $col.Seq.apply[$_](..${operations: Seq[BuilderMacroOperation]}))" =>
        MacroWriteDescription(
          tpe.tpe,
          c.Expr[WriterDerivationConfig](c.untypecheck(config)),
          operations
        )
    }
  }
  ...
  object BuilderMacroOperation {
    ...
    case class Add(tpe: Type, field: Expr[String], fun: Tree, to: Type)
        extends BuilderMacroOperation
  }

  implicit lazy val builderMacroOperationLiftable
      : Liftable[BuilderMacroOperation] = Liftable[BuilderMacroOperation] {
    ...
    case BuilderMacroOperation.Update(tpe, field, name, fun, from, to) =>
      q"$buildersPack.WriterDescription.BuilderOperation.Update.apply[$tpe, $from, $to]($field, ${name
          .map(_.tree)}, $fun)"

    case BuilderMacroOperation.UpdateFromRoot(tpe, field, name, fun, to) =>
      q"$buildersPack.WriterDescription.BuilderOperation.UpdateFromRoot.apply[$tpe, $to]($field, ${name
          .map(_.tree)}, $fun)"

    case BuilderMacroOperation.UpdatePartial(tpe, field, name, fun, to) =>
      q"$buildersPack.WriterDescription.BuilderOperation.UpdatePartial.apply[$tpe, $to]($field, ${name
          .map(_.tree)}, $fun)"

    case BuilderMacroOperation.UpdatePartialFromRoot(tpe, field, name, fun) =>
      q"$buildersPack.WriterDescription.BuilderOperation.UpdatePartialFromRoot.apply[$tpe]($field, ${name
          .map(_.tree)}, $fun)"
  ...
  implicit lazy val builderMacroOperationUnliftable
      : Unliftable[BuilderMacroOperation] = Unliftable[BuilderMacroOperation] {
    ...
    case q"$pack.BuilderOperation.Update.apply[${tpe: Tree}, ${from: Tree}, ${to: Tree}](${field: String}, ${name: Option[Tree]}, ${fun: Tree})" =>
      BuilderMacroOperation.Update(
        tpe.tpe,
        field,
        name.map(c.Expr[String](_)),
        fun,
        from.tpe,
        to.tpe
      )
    ...
    case q"$pack.BuilderOperation.UpdateFromRoot.apply[${tpe: Tree}, ${to: Tree}](${field: String}, ${name: Option[Tree]}, ${fun: Tree})" =>
      BuilderMacroOperation.UpdateFromRoot(
        tpe.tpe,
        field,
        name.map(c.Expr[String](_)),
        fun,
    ...
    case q"$pack.BuilderOperation.UpdatePartial.apply[${tpe: Tree}, ${from: Tree}](${field: String}, ${name: Option[Tree]}, ${fun: Tree})" =>
      BuilderMacroOperation.UpdatePartial(
        tpe.tpe,
        field,
        name.map(c.Expr[String](_)),
        fun,
    ...
    case q"$pack.BuilderOperation.UpdatePartialFromRoot.apply[${tpe: Tree}](${field: String}, ${name: Option[Tree]}, ${fun: Tree})" =>
      BuilderMacroOperation.UpdatePartialFromRoot(
        tpe.tpe,
        field,
        name.map(c.Expr[String](_)),
        fun
