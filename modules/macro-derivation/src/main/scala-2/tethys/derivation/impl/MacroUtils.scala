...
trait MacroUtils
  ...
  implicit lazy val selectChainUnliftable: Unliftable[SelectChain] =
    Unliftable[SelectChain] {
      ...
      case select: Select =>
        def selectAllNames(s: Tree): Seq[String] = s match {
          case Select(rest, name) =>
            selectAllNames(rest) :+ name.decodedName.toString
  ...
  implicit lazy val builderFieldUnliftable: Unliftable[BuilderField] =
    Unliftable[BuilderField] {
  ...
  implicit lazy val optionTreeUnliftable: Unliftable[Option[Tree]] =
    Unliftable[Option[Tree]] {
