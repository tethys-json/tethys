...
object WriterDescription {
  ...
  object BuilderOperation {
    ...
    case class Update[A, B, C](field: String, name: Option[String], fun: B => C)
        extends BuilderOperation[A]
    case class UpdateFromRoot[A, C](
        field: String,
        name: Option[String],
        fun: A => C
    ) extends BuilderOperation[A]
    case class UpdatePartial[A, B](
        field: String,
        name: Option[String],
        fun: PartialFunction[B, Any]
    ) extends BuilderOperation[A]
    case class UpdatePartialFromRoot[A](
        field: String,
        name: Option[String],
        fun: PartialFunction[A, Any]
    ) extends BuilderOperation[A]
