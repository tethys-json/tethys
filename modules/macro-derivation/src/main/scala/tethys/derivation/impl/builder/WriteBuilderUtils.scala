...
trait WriteBuilderUtils extends MacroUtils {
  ...
  object BuilderMacroOperation {
    ...
    case class Update(tpe: Type, field: String, name: Expr[String], fun: Tree, from: Type, to: Type) extends BuilderMacroOperation
    case class UpdateFromRoot(tpe: Type, field: String, name: Expr[String], fun: Tree, to: Type) extends BuilderMacroOperation
    case class UpdatePartial(tpe: Type, field: String, name: Expr[String], fun: Tree, from: Type) extends BuilderMacroOperation
    case class UpdatePartialFromRoot(tpe: Type, field: String, name: Expr[String], fun: Tree) extends BuilderMacroOperation
  ...
  implicit lazy val builderMacroOperationLiftable: Liftable[BuilderMacroOperation] = Liftable[BuilderMacroOperation] {
    ...
    case BuilderMacroOperation.Update(tpe, field, name, fun, from, to) =>
      q"$buildersPack.WriterDescription.BuilderOperation.Update.apply[$tpe, $from, $to]($field, ${name.tree}, $fun)"

    case BuilderMacroOperation.UpdateFromRoot(tpe, field, name, fun, to) =>
      q"$buildersPack.WriterDescription.BuilderOperation.UpdateFromRoot.apply[$tpe, $to]($field, ${name.tree}, $fun)"

    case BuilderMacroOperation.UpdatePartial(tpe, field, name, fun, to) =>
      q"$buildersPack.WriterDescription.BuilderOperation.UpdatePartial.apply[$tpe, $to]($field, ${name.tree}, $fun)"

    case BuilderMacroOperation.UpdatePartialFromRoot(tpe, field, name, fun) =>
      q"$buildersPack.WriterDescription.BuilderOperation.UpdatePartialFromRoot.apply[$tpe]($field, ${name.tree}, $fun)"
  ...
  implicit lazy val builderMacroOperationUnliftable: Unliftable[BuilderMacroOperation] = Unliftable[BuilderMacroOperation] {
    ...
    case q"$pack.BuilderOperation.Update.apply[${tpe: Tree}, ${from: Tree}, ${to: Tree}](${field: String}, ${name: Tree}, ${fun: Tree})" =>
      BuilderMacroOperation.Update(tpe.tpe, field, c.Expr(name), fun, from.tpe, to.tpe)

    case q"$pack.BuilderOperation.UpdateFromRoot.apply[${tpe: Tree}, ${to: Tree}](${field: String}, ${name: Tree}, ${fun: Tree})" =>
      BuilderMacroOperation.UpdateFromRoot(tpe.tpe, field, c.Expr(name), fun, to.tpe)

    case q"$pack.BuilderOperation.UpdatePartial.apply[${tpe: Tree}, ${from: Tree}](${field: String}, ${name: Tree}, ${fun: Tree})" =>
      BuilderMacroOperation.UpdatePartial(tpe.tpe, field, c.Expr(name), fun, from.tpe)

    case q"$pack.BuilderOperation.UpdatePartialFromRoot.apply[${tpe: Tree}](${field: String}, ${name: Tree}, ${fun: Tree})" =>
      BuilderMacroOperation.UpdatePartialFromRoot(tpe.tpe, field, c.Expr(name), fun)
