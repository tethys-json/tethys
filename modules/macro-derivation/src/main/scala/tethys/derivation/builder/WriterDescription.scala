...
object WriterDescription {
  ...
  object BuilderOperation {
    ...
    case class UpdateFromRoot[A, C](field: String, fun: A => C) extends BuilderOperation[A]
    case class UpdatePartial[A, B](field: String, fun: PartialFunction[B, Any]) extends BuilderOperation[A]
    case class UpdatePartialFromRoot[A](field: String, fun: PartialFunction[A, Any]) extends BuilderOperation[A]
